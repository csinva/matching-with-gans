...
def main(args):
    ...
    for src_file in src_files:
        ...
        if not os.path.exists(filename):
            ...
            project_image(proj, src_file, args.dst_dir, args.tmp_dir + os.path.basename(src_file)[:-4],
                          video=args.video)
            if args.video:
                render_video(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--network-pkl', default='gdrive:networks/stylegan2-ffhq-config-f.pkl',
                        help='StyleGAN2 network pickle filename')
    parser.add_argument('--vgg16-pkl', default='https://drive.google.com/uc?id=1N2-m9qszOeVC9Tq77WxsLnuWwOedQiD2',
